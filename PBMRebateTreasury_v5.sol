 ...
 * - flagClaim increments epochClaimedTotal — recall math stays consistent on disputed epochs
    ...
    Pausable
{
        ...
        whenNotPaused
    {
        ...
        // Reserve funds and mark as claimed for recall accounting purposes.
        // epochClaimedTotal is incremented here so that recallUnclaimed() correctly
        // excludes this amount from the unclaimed balance — preventing PoolMismatch.
        // epochVolume is intentionally NOT incremented: that tracks cap consumption
        // against live payouts, not reserved-pending-dispute amounts.

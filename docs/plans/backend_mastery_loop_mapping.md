...
| **Stage 4: Scale & Reliability** | Stateless scaling, load balancing, database scaling, message brokers, rate limiting, observability, resilience patterns | Scoped observability envelope, request throttling, outage tests, local voucher saga endpoint and DLQ tests | `GET /api/health/observability`, `test/DisasterRecoveryOutage.test.js`, `test/VoucherSagaQueue.test.js` | Prometheus/OpenTelemetry export, production multi-instance stress tests, and real broker-backed queues remain open. |

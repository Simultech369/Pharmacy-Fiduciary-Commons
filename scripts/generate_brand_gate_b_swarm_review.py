#!/usr/bin/env python3
"""
Pharmacy Fiduciary Commons — Brand Gate B 7-Lens Expanded Swarm Review Runner

Generates the 7-lens review dossier anchored to:
- Repo: C:\\Users\\Josh\\Desktop\\PBMRebateTreasuryFinal
- Branch: feature/db-proxy
- HEAD: 8fddee0d413a0132863ae335061407eb6c31837c

Output path: review-context/brand_gate_b_funky_swarm_review.md
"""
...
OUTPUT_FILE = os.path.join(ROOT_DIR, "review-context/brand_gate_b_funky_swarm_review.md")

DOSSIER_CONTENT = """# Brand Gate B — Expanded 7-Lens Swarm Review & Consensus Dossier
...
def main():
    ...
    print(f"✅ Generated 7-Lens Swarm Review Dossier to {OUTPUT_FILE}")

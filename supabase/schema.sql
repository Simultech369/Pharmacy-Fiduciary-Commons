...
-- G. Voucher Settlement Saga Queue (proxy-side durable reconciliation state)
...
-- G. Voucher Settlement Saga Policies
...
-- -- 5. VOUCHER SETTLEMENT SAGA PL/PGSQL STATE MACHINE FUNCTIONS
